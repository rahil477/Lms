...
class Student(models.Model):
    ...
    def get_level_count(cls):
        bachelor_count = Student.objects.filter(level=BACHELOR_DEGREE).count()
        master_count = Student.objects.filter(level=MASTER_DEGREE).count()
        
        return {"bachelor": bachelor_count, "master": master_count}
